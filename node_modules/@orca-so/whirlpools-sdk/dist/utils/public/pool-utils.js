...
class PoolUtil {
    ...
    static async isSupportedToken(ctx, whirlpoolsConfig, tokenMintKey) {
        ...
        for (const extension of extensions) {
            switch (extension) {
                ...
                case spl_token_1.ExtensionType.ScaledUiAmountConfig:
                ...
                case spl_token_1.ExtensionType.PausableConfig:
    ...
    static getFeeTierIndex(pool) {
        (0, tiny_invariant_1.default)(pool.feeTierIndexSeed.length == 2, "feeTierIndexSeed length is not 2 (u16, little endian)");
        return new bn_js_1.default(pool.feeTierIndexSeed, "le").toNumber();
    }
    static isInitializedWithAdaptiveFee(pool) {
